    ...
    <>
      <div className="relative h-full">
        <div className={`${darkmode==="dark" ? `bg-${bgcolor}` : `bg-white`} p-10 rounded-lg`}>
          ...
          >
            I have Completed My <span className="font-bold">B.Tech Degree </span>From Pranveer Singh Institute Of Technology <br /> Engineering College, Kanpur.<br/>
            My Specilization in <span className="font-bold">Information Technology (IT) .</span>
          ...
          >
            ...
            creative way.<br />
            I Passionate About  <span className="font-bold">Software Development , </span> <span className="font-bold">Full-Stack Development .</span><br/>
            <br/>
            Proven ability to create <span className="font-bold">Projects  </span> for an
            enterprise-level .<br/>
          </p>
