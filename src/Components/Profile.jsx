...
import Sundram from "../Components/SocialLinks/Sundram.jpg";
      ...
      <div className="w-full flex justify-around">
        ...
        >
          <div className="w-40 h-40 rounded-full  image">
            <img src={Sundram} className="w-screen rounded-lg" />
          </div>
          <h1
          ...
          <div className=" w-96 p-2 flex gap-2 justify-center relative lg:top-10 sm:top-14">
            ...
            >
              <a href="https://x.com/StarkSundram" target="#">
                {" "}
            ...
            >
              <a href="https://www.linkedin.com/in/sundram1/">
                {" "}
            ...
            >
              <a href="https://github.com/sundramsharma1" target="#">
                {" "}
